...
const Text = styled.p<TextProps>`
  ...
  ${({ $fontWeight = "normal" }) =>
    handleResponsiveProp("font-weight", $fontWeight)}
  ${({ $textAlign = "left" }) => handleResponsiveProp("text-align", $textAlign)}
  ${({ $fontStyle = "normal" }) =>
    handleResponsiveProp("font-style", $fontStyle)}
  ${({ $margin = "0" }) => handleResponsiveProp("margin", $margin)}
  ${({ $padding = "0" }) => handleResponsiveProp("padding", $padding)}
  ${({ $lineHeight = "normal" }) =>
    handleResponsiveProp("line-height", $lineHeight)}
  ${({ $letterSpacing = "normal" }) =>
    handleResponsiveProp("letter-spacing", $letterSpacing)}
